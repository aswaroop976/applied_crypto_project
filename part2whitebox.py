...
#Import the necessary functions from the first script file
...
def apply_modification_to_full_size(original_image_path, modified_32_array, output_path):
    #
    #applying modification matrix back to full size source image
    #
...
if __name__ == "__main__":
    """
    source and target image here. update for local enviroment/images
    """
    SOURCE_IMAGE_PATH = "IMG_5737.jpeg" 
    TARGET_IMAGE_PATH = "IMG_4888.jpeg" 
    ...
    ###
    FINAL_PATH = "MODIFIED_FULLSIZE.png"
